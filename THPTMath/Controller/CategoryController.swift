...
class CategoryController: ViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.myImage.image = UIImage(named: ("ic_" + self.list_themeExams[indexPath.row].id));
